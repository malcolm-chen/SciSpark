...
def prompt_conv(title, story, keyword, knowledge, statements):
    ...
    Your response should consist a judgment of whether the child's answer is correct or incorrect, then give a feedback based on the child's answer, an explanation of the answer to the previous question, and finally transit to the next question if the conversation does not end.
    ...
    {{ 
        ...
        "feedback": [Your feedback to the child's answer, such as 'Good job!', 'You are absolutely right', 'That's ok!', etc.],
