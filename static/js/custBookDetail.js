...
function showImage() {
    ...
    currentImage.src = `../static/files/${curUser}/${bookTitle}/pages/page${currentImageIndex}.jpg`;
    updateProgressBar();
    currentSentence = 0;
    ...
    for (let key in genData){
        ...
        for (let sen in genData[key]['section']){
            sentences.push({
                ...
                "audio": `../static/files/${curUser}/${bookTitle}/audio/p${i}sec${j}.mp3`
            })
            j += 1;
        }
...
function updateChatHistory(gptRes){
    ...
    QABlock.innerHTML += `<div class="QAbubble" id="QAbubble_${gptRes.q_id}">
        ...
        <div class="message-user">
            ...
            <img src="../static/files/imgs/${curUser}Icon.jpg" class="avatar">
        </div>
    </div>`;
    /* if(!childRes.correct){
